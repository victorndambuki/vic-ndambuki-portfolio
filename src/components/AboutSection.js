      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-2" style={anim(100)}>
            ...
            {/* Quick-info card */}
            <div className="border border-ash/5 bg-ink-800 p-6">
              {info.map(item => (
                <div
                  key={item.label}
                  className="flex gap-4 py-2.5 border-b border-ash/5 last:border-0"
                >
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div
              className="space-y-5 font-sans font-light text-ash-400 text-base leading-relaxed"
              style={anim(250)}
            >
              <p>
            ...
            <div className="flex flex-wrap gap-4" style={anim(450)}>
              <a
                href="#projects"
                className="group flex items-center gap-2 px-7 py-3 bg-copper text-ink font-sans font-medium text-sm rounded-sm hover:bg-copper-light transition-colors duration-300"
              >
                View Projects
